...
dependencies {
    ...
    // ServerUtils
    compileOnly("net.frankheijden.serverutils:ServerUtils:3.4.3")
    ...
    compileOnly("com.fastasyncworldedit:FastAsyncWorldEdit-Bukkit:2.1.2-SNAPSHOT") { isTransitive = false }
    compileOnly("com.fastasyncworldedit:FastAsyncWorldEdit-Bukkit:2.1.2-SNAPSHOT") { isTransitive = false }
